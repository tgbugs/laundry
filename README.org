#+title: Mobster: Org mode for Racket

An attempt to specify a formal grammar for Org syntax.

The grammar itself is in [[file:./org-mode/parser.rkt]]. Most of the
details of the implementation are described in the comments.
