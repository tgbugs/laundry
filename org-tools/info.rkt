...
(define collection "org-tools")

(define drracket-tools '("mode.rkt"))
(define drracket-tool-names '("Org Mode"))
#; ; TODO
(define drracket-tool-icons '("org-racket.png"))
(define drracket-tool-urls '("https://orgmode.org")) ; not entirely accurate
